...
create: function() { 
  ...
  //  if(mytextbox.value === 'woman'){spaceKey.onDown.add(this.jump, this);}
...
update: function() {
  ...
  //  if(mytextbox.value === 'woman'){spaceKey.onDown.add(this.jump, this);}
    if(mytextbox.value === objectnames[count]){spaceKey.onDown.add(this.jump, this)};
    else{spaceKey.onDown.remove(this.jump, this)};;
        identified += 1;}
        console.log (objectnames[count]);
        console.log (count);
...
restartGame: function() {
    ...
    var identifiednumber = document.getElementById('identifiednumber');
    

//    identifiednumber.value = identified.toString();
...
addOnePix: function(x, y) {
    ...
    var pix = game.add.sprite(1200, pixposition, obstacle);
