...
var mainState = {
    ...
    //load obstacles
    game.load.image('1', 'assets/securityforces.png');
    game.load.image('2', 'assets/medicalworkers.png');
    game.load.image('3', 'assets/rocketsfired.png');
    game.load.image('4', 'assets/hitshospital.png');
    game.load.image('5', 'assets/powerfulcountries.png');
    game.load.image('6', 'assets/rulesofwar.png');
    game.load.image('7', 'assets/floutingwar.png');
    },
...
create: function() { 
    ...
    this.timer = game.time.events.loop(3500, this.addOnePix, this);
...
//    count = Math.floor(Math.random() * 9) + 2;
    ...
    var pix = game.add.sprite(1000, pixposition, obstacle);
    ...
    // Add velocity to the pipe to make it move left
    pix.body.velocity.x = -120; 

    //Change size of the pix
   /* var pixsize = Math.random();
    pix.width = pixsize * (60) + 20;
    pix.height = pixsize * (60) + 20;*/
